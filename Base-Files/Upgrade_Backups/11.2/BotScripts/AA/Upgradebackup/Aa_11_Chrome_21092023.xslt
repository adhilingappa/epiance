...
>
	...
	<xsl:template name="mainChromeTemplate">
		...
		<xsl:element name="CMD">
			...
			<xsl:attribute name="API">
				<xsl:choose>
					...
					<xsl:when test="PlayBack--ControlInfo-Role='list item' and PlayBack--AdditionalInfo-Web_TagName='SELECT'">SelectItemByText</xsl:when>
					<xsl:otherwise>Click</xsl:otherwise>
				</xsl:choose>

				<!--<xsl:call-template name="apiTemplateChrome" /> -->
			</xsl:attribute>
				...
				<xsl:element name="PAR">
					...
					<xsl:attribute name="Type">String</xsl:attribute>
					<xsl:if test="PlayBack--ControlInfo-Role='list item' and PlayBack--AdditionalInfo-Web_TagName='SELECT'">ComboBox</xsl:if>
					<!--<xsl:value-of select="$TextBox"/>-->
					<!--<xsl:call-template name="objTypeTemplateChrome" />-->
				</xsl:element>
				...
				<xsl:element name="PARS">
					<xsl:choose>
						...
						<xsl:when test="PlayBack--ControlInfo-Role='list item' and PlayBack--AdditionalInfo-Web_TagName='SELECT'">
							<xsl:element name="PAR">
								<xsl:attribute name="Name">Text</xsl:attribute>
								<xsl:attribute name="Type">String</xsl:attribute>
								<xsl:value-of select="PlayBack--ControlInfo-ControlData"/>
						...
						<xsl:when test="PlayBack--AdditionalInfo-Web_TagName='A' or PlayBack--AdditionalInfo-Web_TagName='SPAN'">
							<xsl:element name="PAR">
				...
				<xsl:element name="PAR">
					...
					<xsl:attribute name="Type">String</xsl:attribute>
					<xsl:call-template name="SmartObjectTemplateChrome"/>
				</xsl:element>
				...
				<xsl:element name="PAR">
					...
					<xsl:choose>
						...
						<xsl:when test="PlayBack--ControlInfo-Role='list item' and PlayBack--AdditionalInfo-Web_TagName='SELECT'">16</xsl:when>
						<xsl:otherwise>0</xsl:otherwise>
					</xsl:choose>
					<!--<xsl:call-template name="optTemplateChrome" />-->
	...
	<xsl:template name="SmartObjectTemplateChrome">
		&lt;SI&gt;
		&lt;SmartObject&gt;
			&lt;PropertyInformation&gt;
				&lt;AAPropertyInfo&gt;
		<!--
				...
				&lt;AAPropertyInfo&gt;
					&lt;CK&gt;false&lt;/CK&gt;
					&lt;PN&gt;HTML Tag&lt;/PN&gt;
					&lt;PV&gt;<xsl:value-of select="PlayBack--AdditionalInfo-Web_TagName"/>&lt;/PV&gt;
					&lt;SH&gt;false&lt;/SH&gt;
				&lt;/AAPropertyInfo&gt;
		...
		<!--
					<xsl:element name="AAPropertyInfo">
						...
						<PN>Unique ID</PN>
						<PV>
							<xsl:value-of select="utils:guidChrome()"/>
						</PV>
						<SH>false</SH>
					</xsl:element>
					-->
		...
		<xsl:choose>
			...
			<xsl:when test="PlayBack--ControlInfo-Role='list item' and PlayBack--AdditionalInfo-Web_TagName='SELECT'">&lt;SA&gt;SelectItemByText&lt;/SA&gt;</xsl:when>
			<xsl:when test="PlayBack--AdditionalInfo-Web_TagName='svg' or PlayBack--AdditionalInfo-Web_TagName='A' or PlayBack--AdditionalInfo-Web_TagName='SPAN'">&lt;SA&gt;Click&lt;/SA&gt;</xsl:when>
	...
	<xsl:template name="apiTemplateChrome">
		<xsl:choose>
	...
	<xsl:template name="objTypeTemplateChrome">
		<xsl:choose>
	...
	<xsl:template name="optTemplateChrome">
		<xsl:choose>
