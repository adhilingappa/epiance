...
public string getLastGuid(){
			...
			<appdef>
				<xsl:element name="element">
					...
					<xsl:for-each select="Document/Process/Step">
						<xsl:choose>
							<xsl:when test="PlayBack__GeneralInfo_Event='TYPETEXT' or  PlayBack__GeneralInfo_Event = 'KEYEVENT'">
			...
			<xsl:element name="attributes">
				...
				<xsl:element name="attribute">
					...
					<xsl:element name="ProcessValue">
						...
						<xsl:attribute name="value">
							<xsl:value-of select="PlayBack__AdditionalInfo_WHLL_ENDY"/>
						</xsl:attribute>
					</xsl:element>
				</xsl:element>
				...
				<xsl:element name="attribute">
					...
					<xsl:element name="ProcessValue">
						...
						<xsl:attribute name="value">
							<xsl:value-of select="PlayBack__AdditionalInfo_WHLL_ENDX"/>
						</xsl:attribute>
					</xsl:element>
				</xsl:element>
	...
	<xsl:template name="stepTemplate2">
		<xsl:element name="step">
			...
			<xsl:choose>
				<xsl:when test="PlayBack__ControlInfo_ControlData='Enter'">
					<xsl:element name="action">
						<xsl:element name="id">
						...
						<xsl:element name="arguments">
							<xsl:element name="argument">
								...
								<xsl:element name="value">"<xsl:value-of select="concat('{',PlayBack__ControlInfo_ControlData,'}')"/>"</xsl:element>
							</xsl:element>
						</xsl:element>
					</xsl:element>
				</xsl:when>
