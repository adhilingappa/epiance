...
public string getLastGuid(){
	...
	<xsl:template  name="elementTemplateChrome">
		<xsl:element name="element">
			<xsl:attribute name="name">
				<xsl:value-of select="concat('Chr_',PlayBack__ControlInfo_ControlName,' element')"/>
			</xsl:attribute>
			<xsl:element name="id">
				<xsl:value-of select="Step-Guid"/>
			</xsl:element>
			...
			<xsl:element name="attributes">
				...
				<xsl:element name="attribute">
					...
					<xsl:attribute name="inuse">
						<xsl:choose>
							<xsl:when test="PlayBack__ControlInfo_XPath!=''">
								<xsl:value-of select="$true"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="$false"/>
				...
				<xsl:element name="attribute">
					...
					<xsl:attribute name="inuse">
						<xsl:choose>
							<xsl:when test="PlayBack__ControlInfo_XPath='' and PlayBack__AdditionalInfo_Web_Name='' and PlayBack__AdditionalInfo_Web_ID!=''">
								<xsl:value-of select="$true"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="$false"/>
				...
				<xsl:element name="attribute">
					...
					<xsl:attribute name="inuse">
						<xsl:choose>
							<xsl:when test="PlayBack__AdditionalInfo_Web_Name!=''">
								<xsl:value-of select="$true"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="$false"/>
