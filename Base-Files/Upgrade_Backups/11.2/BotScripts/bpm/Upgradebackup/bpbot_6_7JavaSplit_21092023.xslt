...
>
	...
	<xsl:variable name="MouseClickCentre">MouseClickCentre</xsl:variable>
	<xsl:variable name="selectItem">SelectItem</xsl:variable>
	<xsl:variable name="position">position</xsl:variable>
	<xsl:variable name="java">JavaComboBox</xsl:variable>
					...
					<xsl:for-each select="Document/Process/Step">
						<xsl:choose>
							<xsl:when test="PlayBack__GeneralInfo_Event = 'Click' or PlayBack__GeneralInfo_Event = 'Select' or PlayBack__GeneralInfo_Event='TYPETEXT'">
								<xsl:call-template name="elementTemplateJava"/>
							</xsl:when>
	...
	<xsl:template  name="elementTemplateJava">
		<xsl:element name="element">
			<xsl:attribute name="name">
				<xsl:value-of select="concat('Java_',PlayBack__ControlInfo_ControlName)"/>
			</xsl:attribute>
			<xsl:element name="id">
				<xsl:value-of select="Step_Guid"/>
			</xsl:element>
			...
			<xsl:element name="attributes">
				...
				<xsl:element name="attribute">
					...
					<xsl:element name="ProcessValue">
						...
						<xsl:attribute name="value">
							<xsl:value-of select="PlayBack__AdditionalInfo_ACTUAL_CONTROL_TYPE"/>
				...
				<xsl:element name="attribute">
					...
					<xsl:attribute name="inuse">
						<xsl:choose>
							<xsl:when test="PlayBack__AdditionalInfo_CONTROL_DESCRIPTION!=''">
								<xsl:value-of select="$true"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="$false"/>
					...
					<xsl:element name="ProcessValue">
						...
						<xsl:attribute name="value">
							<xsl:value-of select="PlayBack__AdditionalInfo_CONTROL_DESCRIPTION"/>
						</xsl:attribute>
					</xsl:element>
				</xsl:element>
				
				<xsl:element name="attribute">
					<xsl:attribute name="name">ChildCount</xsl:attribute>
					<xsl:attribute name="inuse">
						<xsl:choose>
							<xsl:when test="PlayBack__AdditionalInfo_JAVA_CHILDCOUNT!=''">
								<xsl:value-of select="$true"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="$false"/>
					...
					<xsl:element name="ProcessValue">
						...
						<xsl:attribute name="value">
							<xsl:value-of select="PlayBack__AdditionalInfo_JAVA_CHILDCOUNT"/>
						</xsl:attribute>
					</xsl:element>
				</xsl:element>

				<xsl:element name="attribute">
					<xsl:attribute name="name">Ordinal</xsl:attribute>
					<xsl:attribute name="inuse">
						<xsl:choose>
							<xsl:when test="PlayBack__AdditionalInfo_JAVA_INDEXINPARENT!=''">
								<xsl:value-of select="$true"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="$false"/>
					...
					<xsl:element name="ProcessValue">
						...
						<xsl:attribute name="value">
							<xsl:value-of select="PlayBack__AdditionalInfo_JAVA_INDEXINPARENT"/>
						</xsl:attribute>
					</xsl:element>
				</xsl:element>
		...
		<xsl:element name="step">
			...
			<xsl:element name="action">
				<xsl:element name="id">
					...
					<xsl:value-of select="$MouseClickCentre"/>
				</xsl:element>
