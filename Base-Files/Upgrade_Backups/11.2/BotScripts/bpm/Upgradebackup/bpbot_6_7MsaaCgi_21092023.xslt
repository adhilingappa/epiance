...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:utils="urn:my-scripts" exclude-result-prefixes="msxsl utils">
	...
	<xsl:variable name="stepDelayLaunch">0</xsl:variable>
	...
	public void setAttachGuid(string tempGuid)
	{
	  attachGuid = tempGuid;
	}
					...
					<xsl:when test="PlayBack__GeneralInfo_Event !='WindowActivate'">
						<xsl:choose>
							<xsl:when test="PlayBack__GeneralInfo_Event = 'Click' or PlayBack__GeneralInfo_Event = 'Select'">
								...
								<xsl:if test="utils:ToLower(Pre_Condition_Control_visible) = 'yes' and Include_Pre_Condition_Control_visible = 'true'">
									<xsl:call-template name="waitTemplate">
...
else
{
	...
	<xsl:template name="elementTemplate">
		<xsl:element name="element">
			<xsl:attribute name="name">
				<xsl:value-of select="concat('uia_',BP_PlayBack__ControlInfo_ControlName,' element')"/>
			</xsl:attribute>
			<xsl:element name="id">
			...
			<xsl:element name="attributes">
					...
					<xsl:if test="PlayBack__AdditionalInfo_UIA_AUTOMATIONID">
						<xsl:attribute name="inuse">
							<xsl:choose>
								...
								<xsl:when test="BP_PlayBack__ControlInfo_ControlName = ''">
									<xsl:value-of select="$true"/>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="$false"/>
				...
				<xsl:element name="attribute">
					...
					<xsl:attribute name="inuse">
						<xsl:choose>
							<xsl:when test="Include_BP_PlayBack__ControlInfo_ControlName ='False'">
								<xsl:value-of select="$false"/>
							</xsl:when>
							<xsl:when test="Include_BP_PlayBack__ControlInfo_ControlName ='True'">
								<xsl:value-of select="$true"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="$true"/>
					...
					<xsl:element name="ProcessValue">
						...
						<xsl:attribute name="value">
							<xsl:value-of select="BP_PlayBack__ControlInfo_ControlName"/>
						</xsl:attribute>
					</xsl:element>
				</xsl:element>
				<xsl:element name="attribute">
					...
					<xsl:attribute name="inuse">
						<xsl:choose>
							<xsl:when test="Include_BP_PlayBack__AdditionalInfo_UIA_CLASSNAME ='False'">
								<xsl:value-of select="$false"/>
							</xsl:when>
							<xsl:when test="Include_BP_PlayBack__AdditionalInfo_UIA_CLASSNAME ='True'">
								<xsl:value-of select="$true"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="$false"/>
					...
					<xsl:element name="ProcessValue">
						...
						<xsl:attribute name="value">
							<xsl:value-of select="BP_PlayBack__AdditionalInfo_UIA_CLASSNAME"/>
						</xsl:attribute>
					</xsl:element>
				</xsl:element>
				<xsl:element name="attribute">
				...
				<xsl:element name="attribute">
					...
					<xsl:attribute name="inuse">
						<xsl:choose>
							<xsl:when test="Include_BP_PlayBack__AdditionalInfo_UIA_ACCESSKEY ='False'">
								<xsl:value-of select="$false"/>
							</xsl:when>
							<xsl:when test="Include_BP_PlayBack__AdditionalInfo_UIA_ACCESSKEY ='True'">
								<xsl:value-of select="$true"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="$false"/>
					...
					<xsl:element name="ProcessValue">
						...
						<xsl:attribute name="value">
							<xsl:value-of select="BP_PlayBack__AdditionalInfo_UIA_ACCESSKEY"/>
						</xsl:attribute>
					</xsl:element>
				</xsl:element>
				<xsl:element name="attribute">
				...
				<xsl:element name="attribute">
					...
					<xsl:attribute name="inuse">
						<xsl:choose>
							<xsl:when test="Include_BP_PlayBack__AdditionalInfo_UIA_PARENT_CLASSNAME ='False'">
								<xsl:value-of select="$false"/>
							</xsl:when>
							<xsl:when test="Include_BP_PlayBack__AdditionalInfo_UIA_PARENT_CLASSNAME ='True'">
								<xsl:value-of select="$true"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="$false"/>
					...
					<xsl:element name="ProcessValue">
						...
						<xsl:attribute name="value">
							<xsl:value-of select="BP_PlayBack__AdditionalInfo_UIA_PARENT_CLASSNAME"/>
						</xsl:attribute>
					</xsl:element>
				</xsl:element>
				<xsl:element name="attribute">
					...
					<xsl:attribute name="inuse">
						<xsl:choose>
							<xsl:when test="PlayBack__ControlInfo_Role='combo box' and (BP_PlayBack__AdditionalInfo_UIA_LOCALIZED_CONTROL_TYPE='button' or BP_PlayBack__AdditionalInfo_UIA_LOCALIZED_CONTROL_TYPE='Button')">
								<xsl:value-of select="$true"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="$false"/>
		...
		<xsl:element name="stage">
			...
			<xsl:element name="step">
				...
				<xsl:element name="action">
					<xsl:element name="id">
						<xsl:value-of select="'UIAGetValue'"/>
					</xsl:element>
				</xsl:element>
			</xsl:element>
		</xsl:element>
			...
			<step>
				...
				<action>
					...
					<arguments>
						...
						<argument>
							<id>WindowTitle</id>
							<value>"<xsl:value-of select="/Document/Process/Step/PlayBack__AppInfo_DialogName"/>"</value>
						</argument>
						<argument>
							<id>ProcessName</id>
		...
		<xsl:element name="stage">
			...
			<xsl:choose>
				...
				<xsl:when test="$waitForType='2'">
					<choices>
						<choice reply="True">
							<name>Element Check Exists</name>
							<distance>90</distance>
							<ontrue>
								<xsl:value-of select="utils:getGuid()"/>
							</ontrue>
	...
	<xsl:template name="matchDictionaryTemplate1">
		<xsl:choose>
			...
			<xsl:when test="PlayBack__ControlInfo_Role = 'list item' or BP_PlayBack__AdditionalInfo_UIA_LOCALIZED_CONTROL_TYPE='list item'">UIAListItem</xsl:when>
