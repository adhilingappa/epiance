  ...
  <xsl:template name="typeIntoTemplateGS">
		<xsl:element name="uit:TerminalSetField">
			  ...
			  <xsl:attribute name="FollowedBy">
				<xsl:value-of select="PlayBack__AdditionalInfo_WHLL_NEXT_CONTROL_NAME"/> <!--FollowedBy-->
			  </xsl:attribute>
			  <xsl:attribute name="sap:VirtualizedContainerService.HintSize">
				<xsl:value-of select="$null"/>
			  </xsl:attribute>
			  ...
			  <xsl:attribute name="LabeledBy">
				<xsl:value-of select="PlayBack__AdditionalInfo_WHLL_CURRENT_LABLE"/> <!--LabeledBy-->
			  </xsl:attribute>
	...
	<xsl:template name="SetFieldPositionTemplateGS">
		<xsl:element name="uit:TerminalSetFieldAtPosition">
			  <xsl:attribute name="Column">
				  <xsl:value-of select="PlayBack__AdditionalInfo_WHLL_STARTY"/>
			  </xsl:attribute>
			  <xsl:attribute name="DelayMS">
				<xsl:value-of select="$DelayMS"/>
			  </xsl:attribute>
			...
			<xsl:attribute name="Row">
				<xsl:value-of select="PlayBack__AdditionalInfo_WHLL_STARTX"/>
			</xsl:attribute>
			  <xsl:attribute name="Text">
				<xsl:value-of select="PlayBack__ControlInfo_ControlData"/>
			  </xsl:attribute>
	...
	<xsl:template name="keyToControlKeyMapTemplateGs">
		<xsl:choose>
			<xsl:when test="PlayBack__ControlInfo_ControlData='Enter'">Transmit</xsl:when>
			<xsl:when test="PlayBack__ControlInfo_ControlData='Tab'">Tab</xsl:when>
			<xsl:when test="PlayBack__ControlInfo_ControlData='Backspace'">BackSpace</xsl:when>
			<xsl:otherwise><xsl:value-of select="PlayBack__ControlInfo_ControlData"/></xsl:otherwise>
		</xsl:choose>
	</xsl:template>
