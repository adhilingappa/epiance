	...
	<xsl:template match="/">
        ...
        <xsl:for-each select="Document/Process/Step">
                  ...
                  {  
                      ...
                      processBuilder1.command("cmd.exe", "/c", "ExecuteProcess.exe p lic1.epp");          
                ...
                {  
                    ...
                    processBuilder2.command("cmd.exe", "/c", "ExecuteProcess.exe e <xsl:value-of select="utils:getStepScriptFile(PlayBack__ControlInfo_ControlName,PlayBack__GeneralInfo_Event,Step_ID,$RepoPath)"/>");          
				...
				try
                  {  
                      ...
                      processBuilder3.command("cmd.exe", "/c", "ExecuteProcess.exe s lic1.epp");          
