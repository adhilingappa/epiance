...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <msxsl:script implements-prefix='utils' language='CSharp'>
   ...
   int IncomingId=1;
	...
	public string getStepScriptFile(string controlName,string eventName,string Step_ID,string repo_path)
	{
      ...
      <xsl:element name="bpmn:process">
          ...
          <xsl:element name="bpmn:scriptTask">
            ...
            <xsl:element name="bpmn:script">
              ...
              <xsl:if test="$Stepindex = 1">
					def args = ['cmd', '/c', '\"ExecuteProcess.exe\" p lic1.epp']
					...
					def args1 = ['cmd', '/c', '\"ExecuteProcess.exe\" e <xsl:value-of select="utils:getStepScriptFile(PlayBack__ControlInfo_ControlName,PlayBack__GeneralInfo_Event,Step_ID,$RepoPath)"/>']
        ...
        <xsl:for-each select="Document/Process/Step1">
          <xsl:element name="bpmn:scriptTask">
            ...
            <xsl:element name="bpmn:script">
              <!--bpmn:script-->
              <xsl:value-of select="utils:getStepScriptFile(PlayBack__ControlInfo_ControlName,PlayBack__GeneralInfo_Event,Step_ID,$RepoPath)"/>
            </xsl:element>
          </xsl:element>
        </xsl:for-each>
      </xsl:element>
