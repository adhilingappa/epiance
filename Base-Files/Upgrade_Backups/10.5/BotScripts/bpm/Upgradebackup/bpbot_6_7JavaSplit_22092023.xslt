...
>
	...
	<xsl:template  name="elementTemplateJava">
		<xsl:element name="element">
			<xsl:attribute name="name">
				<xsl:value-of select="concat('Java_',PlayBack--ControlInfo-ControlName)"/>
			</xsl:attribute>
			<xsl:element name="id">
				<xsl:value-of select="Step-Guid"/>
			</xsl:element>
			...
			<xsl:element name="attributes">
				...
				<xsl:element name="attribute">
					...
					<xsl:element name="ProcessValue">
						...
						<xsl:attribute name="value">
							<xsl:value-of select="PlayBack--AdditionalInfo-ACTUAL_CONTROL_TYPE"/>
				...
				<xsl:element name="attribute">
					...
					<xsl:attribute name="inuse">
						<xsl:choose>
							<xsl:when test="PlayBack--AdditionalInfo-CONTROL_DESCRIPTION!=''">
								<xsl:value-of select="$true"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="$false"/>
					...
					<xsl:element name="ProcessValue">
						...
						<xsl:attribute name="value">
							<xsl:value-of select="PlayBack--AdditionalInfo-CONTROL_DESCRIPTION"/>
						</xsl:attribute>
					</xsl:element>
				</xsl:element>
				...
				<xsl:element name="attribute">
					...
					<xsl:attribute name="inuse">
						<xsl:choose>
							<xsl:when test="PlayBack--AdditionalInfo-JAVA_CHILDCOUNT!=''">
								<xsl:value-of select="$true"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="$false"/>
					...
					<xsl:element name="ProcessValue">
						...
						<xsl:attribute name="value">
							<xsl:value-of select="PlayBack--AdditionalInfo-JAVA_CHILDCOUNT"/>
						</xsl:attribute>
					</xsl:element>
				</xsl:element>
				...
				<xsl:element name="attribute">
					...
					<xsl:attribute name="inuse">
						<xsl:choose>
							<xsl:when test="PlayBack--AdditionalInfo-JAVA_INDEXINPARENT!=''">
								<xsl:value-of select="$true"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="$false"/>
					...
					<xsl:element name="ProcessValue">
						...
						<xsl:attribute name="value">
							<xsl:value-of select="PlayBack--AdditionalInfo-JAVA_INDEXINPARENT"/>
						</xsl:attribute>
					</xsl:element>
				</xsl:element>
