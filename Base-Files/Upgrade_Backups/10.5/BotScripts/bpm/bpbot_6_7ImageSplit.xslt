...
>
	...
	<xsl:variable name="dialogName">
		<xsl:value-of select="/Document/Process/Step/PlayBack--AppInfo-DialogName"/>
	</xsl:variable>
	...
	<xsl:template match="/">
		...
		<xsl:element name="process">
			...
			<appdef>
				...
				<xsl:choose>
					<xsl:when test="Document/Process/Step/PlayBack--AppInfo-ExeName = 'chrome.exe'">
						<xsl:call-template name="appTypeInfoTemplateChrome"/>
					</xsl:when>
					<xsl:when test="Document/Process/Step/PlayBack--AppInfo-ExeName = 'iexplore.exe'">
				...
				<attributes>
					...
					<xsl:element name="attribute">
						...
						<xsl:element name="ProcessValue">
							...
							<xsl:attribute name="value">
								<xsl:choose>
									<xsl:when test="PlayBack--AppInfo-ExeName='mstsc.exe'">
										<xsl:value-of select="Standard--Control-Caption"/>
									</xsl:when>
									<xsl:otherwise>
					...
					<xsl:element name="attribute">
						...
						<xsl:element name="ProcessValue">
							...
							<xsl:attribute name="value">
								<xsl:value-of select="Standard--Control-Class"/>
							</xsl:attribute>
						</xsl:element>
					</xsl:element>
					...
					<xsl:element name="attribute">
						...
						<xsl:element name="ProcessValue">
							...
							<xsl:attribute name="value">
								<!--<xsl:value-of select="startX"/>-->
								<xsl:value-of select="MSAA--Control--Location-Left"/>
							</xsl:attribute>
						</xsl:element>
					</xsl:element>
					...
					<xsl:element name="attribute">
						...
						<xsl:element name="ProcessValue">
							...
							<xsl:attribute name="value">
								<!--<xsl:value-of select="startY"/>-->
								<xsl:value-of select="MSAA--Control--Location-Top"/>
							</xsl:attribute>
						</xsl:element>
					</xsl:element>
					...
					<xsl:element name="attribute">
						...
						<xsl:element name="ProcessValue">
							...
							<xsl:attribute name="value">
								<!--<xsl:value-of select="endX"/>-->
								<xsl:value-of select="MSAA--Control--Location-Right"/>
							</xsl:attribute>
						</xsl:element>
					</xsl:element>
					...
					<xsl:element name="attribute">
						...
						<xsl:element name="ProcessValue">
							...
							<xsl:attribute name="value">
								<!--<xsl:value-of select="endY"/>-->
								<xsl:value-of select="MSAA--Control--Location-Bottom"/>
							</xsl:attribute>
						</xsl:element>
					</xsl:element>
					...
					<xsl:element name="attribute">
						...
						<xsl:element name="ProcessValue">
							...
							<xsl:attribute name="value">
								<xsl:value-of select="utils:ImageToBase64(concat($ImagPath,'\',ImageStore--ControlImage--ImageData-FileName))"/>
							</xsl:attribute>
						</xsl:element>
					</xsl:element>
			...
			<attributes>
				...
				<xsl:element name="attribute">
					...
					<xsl:element name="ProcessValue">
						...
						<xsl:attribute name="value">
							<xsl:value-of select="utils:ImageToBase64(concat($ImagPath,'\',ImageStore--FullImage--ImageData-FileName))"/>
						</xsl:attribute>
					</xsl:element>
				</xsl:element>
