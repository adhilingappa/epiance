...
public string getLastGuid(){
	...
	<xsl:template match="/">
		...
		<xsl:element name="process">
			...
			<appdef>
				<xsl:element name="element">
					...
					<xsl:for-each select="Document/Process/Step">
						<xsl:choose>
							<xsl:when test="PlayBack--GeneralInfo-Event = 'Click' or PlayBack--GeneralInfo-Event='DoubleClick' or PlayBack--GeneralInfo-Event = 'Select' or PlayBack--GeneralInfo-Event='TYPETEXT'">
			...
			<xsl:for-each select="Document/Process/Step">
				...
				<xsl:choose>
					<xsl:when test="PlayBack--GeneralInfo-Event = 'Select' and PlayBack--ControlInfo-Role='check box'">
					...
					<xsl:when test="PlayBack--GeneralInfo-Event = 'Click' or PlayBack--GeneralInfo-Event='DoubleClick' or PlayBack--GeneralInfo-Event = 'Select'">
	...
	<xsl:template  name="elementTemplateSap">
		<xsl:element name="element">
			<xsl:attribute name="name">
				<xsl:value-of select="concat(PlayBack--GeneralInfo-Event,' ',PlayBack--ControlInfo-ControlName)"/>
			</xsl:attribute>
			<xsl:element name="id">
				<xsl:value-of select="Step-Guid"/>
			</xsl:element>
				...
				<xsl:element name="attribute">
					...
					<xsl:element name="ProcessValue">
						...
						<xsl:attribute name="value">
							<xsl:value-of select="PlayBack--AdditionalInfo-CONTROL_ABSOLUTE_UNIQUE_ID_FOR_BOT_SCRIPT"/>
						</xsl:attribute>
					</xsl:element>
				</xsl:element>
	...
	<xsl:template name="elementTemplateUia">
		<xsl:element name="element">
			<xsl:attribute name="name">
				<xsl:value-of select="concat('uia_',PlayBack--ControlInfo-ControlName)"/>
			</xsl:attribute>
			<xsl:element name="id">
				<xsl:value-of select="utils:guid()"/>
			</xsl:element>
	...
	<xsl:template name="stepTemplate">
		<xsl:element name="step">
			...
			<xsl:element name="action">
				...
				<xsl:choose>
					<xsl:when test="PlayBack--ControlInfo-Role='SAPGuiTextField' or PlayBack--ControlInfo-Role='SAPGuiCTextField'">
						<xsl:element name="id">
							<xsl:value-of select="$setFocus"/>
						</xsl:element>
					</xsl:when>
					<xsl:when test="PlayBack--ControlInfo-Role='SAPGuiButton'">
						<xsl:element name="id">
					...
					<xsl:when test="PlayBack--ControlInfo-Role='SAPTree'">
						...
						<xsl:element name="arguments">
							<xsl:element name="argument">
								...
								<xsl:element name="value">"<xsl:value-of select="PlayBack--ControlInfo-ControlData"/>"</xsl:element>
							</xsl:element>
						</xsl:element>
					</xsl:when>
					<xsl:when test="PlayBack--ControlInfo-Role='SAPGuiRadioButton'  or PlayBack--ControlInfo-Role='SAPGuiTab'">
						<xsl:element name="id">
	...
	<xsl:template name="stepTemplate2">
		<xsl:element name="step">
			<xsl:attribute name="expr">
				<xsl:choose>
					<xsl:when test="PlayBack--ControlInfo-ControlData='1'">
						<xsl:value-of select="$true"/>
					</xsl:when>
					<xsl:when test="PlayBack--ControlInfo-ControlData='0'">
						<xsl:value-of select="$false"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="$true"/>
...
-->
	...
	<xsl:template name="matchDictionaryTemplate">
		<xsl:choose>
			<xsl:when test="PlayBack--ControlInfo-Role = 'SAPGuiTextField'">GuiTextField</xsl:when>
			<xsl:when test="PlayBack--ControlInfo-Role = 'SAPGuiPasswordField'">GuiPasswordField</xsl:when>
			<xsl:when test="PlayBack--ControlInfo-Role = 'SAPGuiButton'">SAPButton</xsl:when>
			<xsl:when test="PlayBack--ControlInfo-Role = 'SAPTree'">GuiShell</xsl:when>
			<xsl:when test="PlayBack--ControlInfo-Role = 'SAPGuiCTextField'">GuiCTextField</xsl:when>
			<xsl:when test="PlayBack--ControlInfo-Role = 'SAPGuiRadioButton'">GuiRadioButton</xsl:when>
			<xsl:when test="PlayBack--ControlInfo-Role = 'check box'">GuiCheckBox</xsl:when>
			<xsl:otherwise>
	...
	<xsl:template name="matchDictionaryTemplate1">
		<xsl:choose>
			<xsl:when test="PlayBack--ControlInfo-Role = 'SAPGuiTextField'">SAPTextBox</xsl:when>
			<xsl:when test="PlayBack--ControlInfo-Role = 'SAPGuiPasswordField'">SAPPasswordField</xsl:when>
			<xsl:when test="PlayBack--ControlInfo-Role = 'SAPGuiButton'">SAPButton</xsl:when>
			<xsl:when test="PlayBack--ControlInfo-Role = 'SAPTree'">SAPCtrlTree</xsl:when>
			<xsl:when test="PlayBack--ControlInfo-Role = 'SAPGuiCTextField'">SAPTextBox</xsl:when>
			<xsl:when test="PlayBack--ControlInfo-Role = 'SAPGuiRadioButton'">SAPRadioButton</xsl:when>
			<xsl:when test="PlayBack--ControlInfo-Role = 'check box'">SAPCheckBox</xsl:when>
			<xsl:otherwise>
				<xsl:variable name="sapRole">
					<xsl:value-of select="PlayBack--ControlInfo-Role"/>
				</xsl:variable>
